...
class TransactionContext:
    ...
    def __enter__(self):
        logger.debug("transaction.begin", correlation_id=self.correlation_id)
        return self
    ...
    def commit(self):
        ...
        logger.info("transaction.commit", correlation_id=self.correlation_id)
    ...
    def rollback(self):
        ...
        logger.info("transaction.rollback", correlation_id=self.correlation_id)
...
class MetadataDatabase:
    ...
    def connect(self, correlation_id: str) -> None:
        ...
        """
        self.logger.info("database.connect", correlation_id=correlation_id)
    ...
    def health_check(self, correlation_id: str) -> bool:
        ...
        """
        self.logger.debug(
            "database.health_check", correlation_id=correlation_id, connected=self._connected
        )
        return self._connected
    ...
    def disconnect(self, correlation_id: str) -> None:
        ...
        """
        if self._connected:
            self.logger.info("database.disconnect", correlation_id=correlation_id)
            self._connected = False
        else:
            self.logger.debug(
    ...
    def begin_transaction(self, correlation_id: str) -> TransactionContext:
        ...
        """
        self.logger.debug("database.begin_transaction", correlation_id=correlation_id)
